package com.weiwei.project.controller;
...
import com.weiwei.project.annotation.AuthCheck;
import com.weiwei.project.common.*;
import com.weiwei.project.constant.CommonConstant;
import com.weiwei.project.constant.UserConstant;
import com.weiwei.project.exception.BusinessException;
import com.weiwei.project.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.weiwei.project.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.weiwei.project.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.weiwei.project.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.weiwei.project.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        EasyApiClient apiClient = new EasyApiClient(accessKey, secretKey);
        apiClient.setGATEWAY_HOST("http://localhost:8090");
        //判断接口是否可以调用
        String invokeResult = apiClient.onlineInvoke(userRequestParams, url);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Long id = interfaceInfoInvokeRequest.getId();
        log.info("invoke .... ... ...  : " + interfaceInfoInvokeRequest);
        String userRequestParams = interfaceInfoInvokeRequest.getUserRequestParams();
        //校验该接口是否存在
        InterfaceInfo oldInterfaceInfo = interfaceInfoService.getById(id);
        if (oldInterfaceInfo == null) {
        ...
        apiClient.setGATEWAY_HOST("http://localhost:8090");
        //Gson gson = new Gson();
        //com.weiwei.easyapiclientsdk.model.User user = gson.fromJson(userRequestParams, com.weiwei.easyapiclientsdk.model.User.class);
        String invokeResult = apiClient.onlineInvoke(userRequestParams, url);
        //com.weiwei.easyapiclientsdk.model.User user = new com.weiwei.easyapiclientsdk.model.User();
        //user.setUsername(interfaceInfoInvokeRequest.getUserRequestParams());
        //String usernameByPost = apiClient.getUsernameByPost(interfaceInfoInvokeRequest.getUserRequestParams());
